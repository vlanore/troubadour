...
def add_button(
    ...
    if tooltip is not None:
        render_tooltip(f"troubadour_button_{id}", make_rich_text(tooltip))
...
def add_text_input(
    ...
    if tooltip is not None:
        render_tooltip(f"troubadour_inputtext_button_{id}", make_rich_text(tooltip))
